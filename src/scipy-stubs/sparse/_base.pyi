...
class sparray(Protocol[_ShapeAnno, _DType_co]):
    ...
    @overload
    def trace(self: sparray[Any, Any], offset: SupportsIndex = ...) -> Any: ...
    @overload
    def todense(
        self, order: _OrderType | None = ..., out: None = ...
    ) -> np.ndarray[_ShapeAnno, _DType_co]: ...
    ...
    @property
    def real(self) -> sparray[_ShapeAnno, Any]: ...
    @property
    def imag(self) -> sparray[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: None = ...,
    ) -> sparray[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
    ...
    def __pow__(self, n: _NumberLike_co) -> sparray[_ShapeAnno, Any]: ...
