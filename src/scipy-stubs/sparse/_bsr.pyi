...
class bsr_array(sparray[_ShapeAnno, _DType_co], IndexMixin):
    ...
    @overload
    def trace(self: bsr_array[Any, Any], offset: SupportsIndex = ...) -> Any: ...
    @overload
    def todense(
        self, order: _OrderType | None = ..., out: None = ...
    ) -> np.ndarray[_ShapeAnno, _DType_co]: ...
    ...
    @property
    def real(self) -> bsr_array[_ShapeAnno, Any]: ...
    @property
    def imag(self) -> bsr_array[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: None = ...,
    ) -> bsr_array[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
    ...
    @property
    def T(self) -> bsr_array[Any, _DType_co]: ...
    def transpose(
        self, axes: None = ..., copy: bool = ...
    ) -> bsr_array[Any, _DType_co]: ...
    ###########################################################################
    ...
    def sin(self) -> bsr_array[_ShapeAnno, Any]: ...
    def tan(self) -> bsr_array[_ShapeAnno, Any]: ...
    def arcsin(self) -> bsr_array[_ShapeAnno, Any]: ...
    def arctan(self) -> bsr_array[_ShapeAnno, Any]: ...
    def sinh(self) -> bsr_array[_ShapeAnno, Any]: ...
    def tanh(self) -> bsr_array[_ShapeAnno, Any]: ...
    def arcsinh(self) -> bsr_array[_ShapeAnno, Any]: ...
    def arctanh(self) -> bsr_array[_ShapeAnno, Any]: ...
    def rint(self) -> bsr_array[_ShapeAnno, Any]: ...
    def sign(self) -> bsr_array[_ShapeAnno, Any]: ...
    def expm1(self) -> bsr_array[_ShapeAnno, Any]: ...
    def log1p(self) -> bsr_array[_ShapeAnno, Any]: ...
    def deg2rad(self) -> bsr_array[_ShapeAnno, Any]: ...
    def rad2deg(self) -> bsr_array[_ShapeAnno, Any]: ...
    def floor(self) -> bsr_array[_ShapeAnno, Any]: ...
    def ceil(self) -> bsr_array[_ShapeAnno, Any]: ...
    def trunc(self) -> bsr_array[_ShapeAnno, Any]: ...
    def sqrt(self) -> bsr_array[_ShapeAnno, Any]: ...
    ###########################################################################
...
class bsr_matrix(spmatrix[_ShapeAnno, _DType_co], IndexMixin):
    ...
    @overload
    def trace(self: bsr_matrix[Any, Any], offset: SupportsIndex = ...) -> Any: ...
    @overload
    def todense(
        self, order: _OrderType | None = ..., out: None = ...
    ...
    @property
    def real(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    @property
    def imag(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: None = ...,
    ) -> bsr_matrix[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
    ...
    @property
    def T(self) -> bsr_matrix[Any, _DType_co]: ...
    def transpose(
        self, axes: None = ..., copy: bool = ...
    ) -> bsr_matrix[Any, _DType_co]: ...
    ###########################################################################
    # common methods from _bsr_base
    ###########################################################################
    @property
    ...
    # dynamically set unary ufuncs:
    def sin(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    def tan(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    def arcsin(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    def arctan(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    def sinh(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    def tanh(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    def arcsinh(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    def arctanh(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    def rint(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    def sign(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    def expm1(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    def log1p(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    def deg2rad(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    def rad2deg(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    def floor(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    def ceil(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    def trunc(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    def sqrt(self) -> bsr_matrix[_ShapeAnno, Any]: ...
    ###########################################################################
    # common methods from _minmax_mixin
    ###########################################################################
    @overload
