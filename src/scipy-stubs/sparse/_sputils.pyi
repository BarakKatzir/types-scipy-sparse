...
@overload
def isshape(
    x: Any, nonneg: bool = ..., *, allow_1d: Literal[True]
...
@overload
def asmatrix(
    data: np.ndarray[_ShapeType, _DType], dtype: None = ...
) -> np.matrix[_ShapeType, _DType]: ...
@overload
def asmatrix(
    data: np.ndarray[_ShapeType, Any], dtype: _DType
) -> np.matrix[_ShapeType, _DType]: ...
@overload
def asmatrix(
    data: np.ndarray[_ShapeType, Any], dtype: _DTypeLike[_SCT]
) -> np.matrix[_ShapeType, np.dtype[_SCT]]: ...
@overload
def asmatrix(
    data: np.ndarray[_ShapeType, Any], dtype: npt.DTypeLike
) -> np.matrix[_ShapeType, np.dtype[Any]]: ...
