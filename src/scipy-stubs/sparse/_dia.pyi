...
class dia_array(sparray[_ShapeAnno, _DType_co]):
    ...
    @overload
    def trace(self: dia_array[Any, Any], offset: SupportsIndex = ...) -> Any: ...
    @overload
    def todense(
        self, order: _OrderType | None = ..., out: None = ...
    ) -> np.ndarray[_ShapeAnno, _DType_co]: ...
    ...
    @property
    def real(self) -> dia_array[_ShapeAnno, Any]: ...
    @property
    def imag(self) -> dia_array[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: None = ...,
    ) -> dia_array[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
    ...
    @property
    def T(self) -> dia_array[Any, _DType_co]: ...
    def transpose(
        self, axes: None = ..., copy: bool = ...
    ) -> dia_array[Any, _DType_co]: ...
    ###########################################################################
    # common methods from _dia_base
    ###########################################################################
    offsets: np.ndarray[Any, np.dtype[np.int_]]
    ...
    def sin(self) -> dia_array[_ShapeAnno, Any]: ...
    def tan(self) -> dia_array[_ShapeAnno, Any]: ...
    def arcsin(self) -> dia_array[_ShapeAnno, Any]: ...
    def arctan(self) -> dia_array[_ShapeAnno, Any]: ...
    def sinh(self) -> dia_array[_ShapeAnno, Any]: ...
    def tanh(self) -> dia_array[_ShapeAnno, Any]: ...
    def arcsinh(self) -> dia_array[_ShapeAnno, Any]: ...
    def arctanh(self) -> dia_array[_ShapeAnno, Any]: ...
    def rint(self) -> dia_array[_ShapeAnno, Any]: ...
    def sign(self) -> dia_array[_ShapeAnno, Any]: ...
    def expm1(self) -> dia_array[_ShapeAnno, Any]: ...
    def log1p(self) -> dia_array[_ShapeAnno, Any]: ...
    def deg2rad(self) -> dia_array[_ShapeAnno, Any]: ...
    def rad2deg(self) -> dia_array[_ShapeAnno, Any]: ...
    def floor(self) -> dia_array[_ShapeAnno, Any]: ...
    def ceil(self) -> dia_array[_ShapeAnno, Any]: ...
    def trunc(self) -> dia_array[_ShapeAnno, Any]: ...
    def sqrt(self) -> dia_array[_ShapeAnno, Any]: ...
...
class dia_matrix(spmatrix[_ShapeAnno, _DType_co]):
    ...
    @overload
    def trace(self: dia_matrix[Any, Any], offset: SupportsIndex = ...) -> Any: ...
    @overload
    def todense(
        self, order: _OrderType | None = ..., out: None = ...
    ...
    @property
    def real(self) -> dia_matrix[_ShapeAnno, Any]: ...
    @property
    def imag(self) -> dia_matrix[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: None = ...,
    ) -> dia_matrix[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
    ...
    @property
    def T(self) -> dia_matrix[Any, _DType_co]: ...
    def transpose(
        self, axes: None = ..., copy: bool = ...
    ) -> dia_matrix[Any, _DType_co]: ...
    ###########################################################################
    # common methods from _dia_base
    ###########################################################################
    offsets: np.ndarray[Any, np.dtype[np.int_]]
    ...
    # dynamically set unary ufuncs:
    def sin(self) -> dia_matrix[_ShapeAnno, Any]: ...
    def tan(self) -> dia_matrix[_ShapeAnno, Any]: ...
    def arcsin(self) -> dia_matrix[_ShapeAnno, Any]: ...
    def arctan(self) -> dia_matrix[_ShapeAnno, Any]: ...
    def sinh(self) -> dia_matrix[_ShapeAnno, Any]: ...
    def tanh(self) -> dia_matrix[_ShapeAnno, Any]: ...
    def arcsinh(self) -> dia_matrix[_ShapeAnno, Any]: ...
    def arctanh(self) -> dia_matrix[_ShapeAnno, Any]: ...
    def rint(self) -> dia_matrix[_ShapeAnno, Any]: ...
    def sign(self) -> dia_matrix[_ShapeAnno, Any]: ...
    def expm1(self) -> dia_matrix[_ShapeAnno, Any]: ...
    def log1p(self) -> dia_matrix[_ShapeAnno, Any]: ...
    def deg2rad(self) -> dia_matrix[_ShapeAnno, Any]: ...
    def rad2deg(self) -> dia_matrix[_ShapeAnno, Any]: ...
    def floor(self) -> dia_matrix[_ShapeAnno, Any]: ...
    def ceil(self) -> dia_matrix[_ShapeAnno, Any]: ...
    def trunc(self) -> dia_matrix[_ShapeAnno, Any]: ...
    def sqrt(self) -> dia_matrix[_ShapeAnno, Any]: ...
