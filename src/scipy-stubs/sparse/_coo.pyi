...
class coo_array(sparray[_ShapeAnno, _DType_co]):
    ...
    @overload
    def trace(self: coo_array[Any, Any], offset: SupportsIndex = ...) -> Any: ...
    @overload
    def todense(
        self, order: _OrderType | None = ..., out: None = ...
    ) -> np.ndarray[_ShapeAnno, _DType_co]: ...
    ...
    @property
    def real(self) -> coo_array[_ShapeAnno, Any]: ...
    @property
    def imag(self) -> coo_array[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: None = ...,
    ) -> coo_array[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
    ...
    ###########################################################################
    coords: (
        tuple[np.ndarray[Any, np.dtype[np.int_]], np.ndarray[Any, np.dtype[np.int_]]]
    ...
    @property
    def row(self) -> np.ndarray[Any, np.dtype[np.int_]]: ...
    @row.setter
    def row(self, new_row: npt.ArrayLike) -> None: ...
    @property
    def col(self) -> np.ndarray[Any, np.dtype[np.int_]]: ...
    @col.setter
    ...
    def sin(self) -> coo_array[_ShapeAnno, Any]: ...
    def tan(self) -> coo_array[_ShapeAnno, Any]: ...
    def arcsin(self) -> coo_array[_ShapeAnno, Any]: ...
    def arctan(self) -> coo_array[_ShapeAnno, Any]: ...
    def sinh(self) -> coo_array[_ShapeAnno, Any]: ...
    def tanh(self) -> coo_array[_ShapeAnno, Any]: ...
    def arcsinh(self) -> coo_array[_ShapeAnno, Any]: ...
    def arctanh(self) -> coo_array[_ShapeAnno, Any]: ...
    def rint(self) -> coo_array[_ShapeAnno, Any]: ...
    def sign(self) -> coo_array[_ShapeAnno, Any]: ...
    def expm1(self) -> coo_array[_ShapeAnno, Any]: ...
    def log1p(self) -> coo_array[_ShapeAnno, Any]: ...
    def deg2rad(self) -> coo_array[_ShapeAnno, Any]: ...
    def rad2deg(self) -> coo_array[_ShapeAnno, Any]: ...
    def floor(self) -> coo_array[_ShapeAnno, Any]: ...
    def ceil(self) -> coo_array[_ShapeAnno, Any]: ...
    def trunc(self) -> coo_array[_ShapeAnno, Any]: ...
    def sqrt(self) -> coo_array[_ShapeAnno, Any]: ...
    ###########################################################################
...
class coo_matrix(spmatrix[_ShapeAnno, _DType_co]):
    ...
    @overload
    def trace(self: coo_matrix[Any, Any], offset: SupportsIndex = ...) -> Any: ...
    @overload
    def todense(
        self, order: _OrderType | None = ..., out: None = ...
    ...
    @property
    def real(self) -> coo_matrix[_ShapeAnno, Any]: ...
    @property
    def imag(self) -> coo_matrix[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: None = ...,
    ) -> coo_matrix[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
    ...
    # dynamically set unary ufuncs:
    def sin(self) -> coo_matrix[_ShapeAnno, Any]: ...
    def tan(self) -> coo_matrix[_ShapeAnno, Any]: ...
    def arcsin(self) -> coo_matrix[_ShapeAnno, Any]: ...
    def arctan(self) -> coo_matrix[_ShapeAnno, Any]: ...
    def sinh(self) -> coo_matrix[_ShapeAnno, Any]: ...
    def tanh(self) -> coo_matrix[_ShapeAnno, Any]: ...
    def arcsinh(self) -> coo_matrix[_ShapeAnno, Any]: ...
    def arctanh(self) -> coo_matrix[_ShapeAnno, Any]: ...
    def rint(self) -> coo_matrix[_ShapeAnno, Any]: ...
    def sign(self) -> coo_matrix[_ShapeAnno, Any]: ...
    def expm1(self) -> coo_matrix[_ShapeAnno, Any]: ...
    def log1p(self) -> coo_matrix[_ShapeAnno, Any]: ...
    def deg2rad(self) -> coo_matrix[_ShapeAnno, Any]: ...
    def rad2deg(self) -> coo_matrix[_ShapeAnno, Any]: ...
    def floor(self) -> coo_matrix[_ShapeAnno, Any]: ...
    def ceil(self) -> coo_matrix[_ShapeAnno, Any]: ...
    def trunc(self) -> coo_matrix[_ShapeAnno, Any]: ...
    def sqrt(self) -> coo_matrix[_ShapeAnno, Any]: ...
    ###########################################################################
    # common methods from _minmax_mixin
    ###########################################################################
    @overload
