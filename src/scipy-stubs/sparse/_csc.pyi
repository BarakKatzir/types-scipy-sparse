...
class csc_array(sparray[_ShapeAnno, _DType_co], IndexMixin):
    ...
    @overload
    def trace(self: csc_array[Any, Any], offset: SupportsIndex = ...) -> Any: ...
    @overload
    def todense(
        self, order: _OrderType | None = ..., out: None = ...
    ) -> np.ndarray[_ShapeAnno, _DType_co]: ...
    ...
    @property
    def real(self) -> csc_array[_ShapeAnno, Any]: ...
    @property
    def imag(self) -> csc_array[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: None = ...,
    ) -> csc_array[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
    ...
    @property
    def T(self) -> csr_array[Any, _DType_co]: ...
    def transpose(
        self, axes: None = ..., copy: bool = ...
    ) -> csr_array[Any, _DType_co]: ...
    ###########################################################################
    ...
    def sin(self) -> csc_array[_ShapeAnno, Any]: ...
    def tan(self) -> csc_array[_ShapeAnno, Any]: ...
    def arcsin(self) -> csc_array[_ShapeAnno, Any]: ...
    def arctan(self) -> csc_array[_ShapeAnno, Any]: ...
    def sinh(self) -> csc_array[_ShapeAnno, Any]: ...
    def tanh(self) -> csc_array[_ShapeAnno, Any]: ...
    def arcsinh(self) -> csc_array[_ShapeAnno, Any]: ...
    def arctanh(self) -> csc_array[_ShapeAnno, Any]: ...
    def rint(self) -> csc_array[_ShapeAnno, Any]: ...
    def sign(self) -> csc_array[_ShapeAnno, Any]: ...
    def expm1(self) -> csc_array[_ShapeAnno, Any]: ...
    def log1p(self) -> csc_array[_ShapeAnno, Any]: ...
    def deg2rad(self) -> csc_array[_ShapeAnno, Any]: ...
    def rad2deg(self) -> csc_array[_ShapeAnno, Any]: ...
    def floor(self) -> csc_array[_ShapeAnno, Any]: ...
    def ceil(self) -> csc_array[_ShapeAnno, Any]: ...
    def trunc(self) -> csc_array[_ShapeAnno, Any]: ...
    def sqrt(self) -> csc_array[_ShapeAnno, Any]: ...
    ###########################################################################
...
class csc_matrix(spmatrix[_ShapeAnno, _DType_co], IndexMixin):
    ...
    @overload
    def trace(self: csc_matrix[Any, Any], offset: SupportsIndex = ...) -> Any: ...
    @overload
    def todense(
        self, order: _OrderType | None = ..., out: None = ...
    ...
    @property
    def real(self) -> csc_matrix[_ShapeAnno, Any]: ...
    @property
    def imag(self) -> csc_matrix[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: None = ...,
    ) -> csc_matrix[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
    ...
    @property
    def T(self) -> csr_matrix[Any, _DType_co]: ...
    def transpose(
        self, axes: None = ..., copy: bool = ...
    ...
    # dynamically set unary ufuncs:
    def sin(self) -> csc_matrix[_ShapeAnno, Any]: ...
    def tan(self) -> csc_matrix[_ShapeAnno, Any]: ...
    def arcsin(self) -> csc_matrix[_ShapeAnno, Any]: ...
    def arctan(self) -> csc_matrix[_ShapeAnno, Any]: ...
    def sinh(self) -> csc_matrix[_ShapeAnno, Any]: ...
    def tanh(self) -> csc_matrix[_ShapeAnno, Any]: ...
    def arcsinh(self) -> csc_matrix[_ShapeAnno, Any]: ...
    def arctanh(self) -> csc_matrix[_ShapeAnno, Any]: ...
    def rint(self) -> csc_matrix[_ShapeAnno, Any]: ...
    def sign(self) -> csc_matrix[_ShapeAnno, Any]: ...
    def expm1(self) -> csc_matrix[_ShapeAnno, Any]: ...
    def log1p(self) -> csc_matrix[_ShapeAnno, Any]: ...
    def deg2rad(self) -> csc_matrix[_ShapeAnno, Any]: ...
    def rad2deg(self) -> csc_matrix[_ShapeAnno, Any]: ...
    def floor(self) -> csc_matrix[_ShapeAnno, Any]: ...
    def ceil(self) -> csc_matrix[_ShapeAnno, Any]: ...
    def trunc(self) -> csc_matrix[_ShapeAnno, Any]: ...
    def sqrt(self) -> csc_matrix[_ShapeAnno, Any]: ...
    ###########################################################################
    # common methods from _minmax_mixin
    ###########################################################################
    @overload
