...
class lil_array(sparray[_ShapeAnno, _DType_co], IndexMixin):
    ...
    @overload
    def trace(self: lil_array[Any, Any], offset: SupportsIndex = ...) -> Any: ...
    @overload
    def todense(
        self, order: _OrderType | None = ..., out: None = ...
    ) -> np.ndarray[_ShapeAnno, _DType_co]: ...
    ...
    @property
    def real(self) -> lil_array[_ShapeAnno, Any]: ...
    @property
    def imag(self) -> lil_array[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: None = ...,
    ) -> lil_array[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
    ...
    @property
    def T(self) -> lil_array[Any, _DType_co]: ...
    def transpose(
        self, axes: None = ..., copy: bool = ...
    ) -> lil_array[Any, _DType_co]: ...
    ###########################################################################
    # common methods from _lil_base
    ###########################################################################
    dtype: _DType_co
    rows: np.ndarray[Any, np.dtype[np.object_]]  # ndarray of lists
...
class lil_matrix(spmatrix[_ShapeAnno, _DType_co], IndexMixin):
    ...
    @overload
    def trace(self: lil_matrix[Any, Any], offset: SupportsIndex = ...) -> Any: ...
    @overload
    def todense(
        self, order: _OrderType | None = ..., out: None = ...
    ...
    @property
    def real(self) -> lil_matrix[_ShapeAnno, Any]: ...
    @property
    def imag(self) -> lil_matrix[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
        dtype: None = ...,
    ) -> lil_matrix[_ShapeAnno, Any]: ...
    @overload
    def power(
        self,
        n: _NumberLike_co,
    ...
    @property
    def T(self) -> lil_matrix[Any, _DType_co]: ...
    def transpose(
        self, axes: None = ..., copy: bool = ...
    ) -> lil_matrix[Any, _DType_co]: ...
    ###########################################################################
    # common methods from _lil_base
    ###########################################################################
    dtype: _DType_co
